...
<#list keys as key>
    ...
    <div class="panel-body">
			...
			<div class="owl-carousel">
 			...
 			<div class="item" ><p style="text-align:center;padding-top:0px;"><b>${product['name']}</b></p><img class="itemImgs"  src=" ${product['images'][0] }" /><p style="text-align:center;padding-top:20px;"><b><#if product?size==3><#else>${product['price']} Rs.</#if></b></p></div>
				 </#list> 
			</div>
			</div>
			</div>
